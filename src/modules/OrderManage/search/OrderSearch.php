 ...
 class OrderSearch extends Order
{
    ...
    public function rules()
    {
        return [
            ...
            [['status', 'payment_method', 'note', 'include_vat', 'customer_username', 'customer_phone', 'customer_name', 'customer_email', 'customer_address', 'customer_company', 'customer_area', 'customer_tax_number', 'created_at', 'updated_at'], 'safe'],
        ];
    }
